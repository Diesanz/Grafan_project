...
La carga instantánea de CPU se muestra en el panel de Grafana bajo la visualización llamada ''Gauge'' ya que es el tipo de visualización que mejor muestra este valor.\\

Está configurado para que muestre el valor exacto de la carga y una semicircunferencia que se completa en base a dicho valor. La visualización puede cambiar de color según el porcentaje de la carga de CPU, verde representa del 0\% al 60\%, amarillo del 60\% al 90\%, y rojo del 90\% al 100\%.\\

La consulta realizada a la base de datos es \lstinline{SELECT carga FROM grafana.cpu;}

\subsection{Frecuencia CPU}

La frecuencia instantánea de CPU se muestra en el panel de Grafana bajo la visualización llamada ''Gauge'' ya que es el tipo de visualización que mejor muestra este valor.\\

Está configurado para que muestre el valor exacto de la frecuencia y una semicircunferencia que va desde el valor de 0 hasta 4000. Se ha supuesto el valor de 4000 como frecuencia máxima de la CPU debido a que la media suele ser 2000 y la máquina virtual no mostraba cuál podría ser este valor máximo. La visualización puede cambiar de color según el porcentaje de la carga de CPU, verde representa del 0\% al 80\%, amarillo del 80\% al 90\%, y rojo del 90\% al 100\% del valor máximo de la frecuencia de CPU (en nuestro caso 4000).\\

La consulta realizada a la base de datos es \lstinline{SELECT frecuencia FROM grafana.cpu;}
